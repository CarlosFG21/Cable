<?php
    ...
    class DetalleServicio{
        ...
        public function validarDetalle($direccion,$servicio){
            ...
            $sql = "select id_direccion,id_servicio from detalle_servicio where id_direccion='".$direccion."'" . "and id_servicio='".$servicio."'";
            ...
            while($fila =  mysqli_fetch_array($ejecutar)){
                ...
                if(strcmp($fila[0],$direccion)===0 && strcmp($fila[1],$servicio)===0){
                    $resultado = 1;
                    break;
                }
            }
